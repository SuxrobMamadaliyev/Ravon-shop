...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "RqvonBrend — premium onlayn do'kon" },
      {
        name: "description",
        content:
          "Xitoydan olib kelinadigan sifatli mahsulotlar. O'zbekiston bo'ylab BTS Pochta orqali yetkazib berish, Payme va Click orqali to'lov.",
      },
